"""Estimand expression parsing.

Parses cell-means arithmetic like "(treated, mutant) - (control, wt)" or
coefficient expressions like "coef(treatmentX)" into weight dictionaries.
"""
