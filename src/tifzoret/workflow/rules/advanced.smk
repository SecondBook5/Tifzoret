...
rule contrast_curvature:
    input: edges=analysis("advanced/wgcna", "tables/coexpression_edges.tsv"), nodes=analysis("advanced/wgcna", "tables/coexpression_nodes.tsv"), config=str(CONFIG_PATH), script=str(WORKFLOW_ROOT / "scripts" / "curvature.py")
