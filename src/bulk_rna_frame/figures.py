    ...
    recipe = {
        "figure_sets": {
            "primary": {
                ...
                "description": "Edit constructors, variants, and placement; run bulk-rna figures gallery to review alternatives.",
                "width": 12,
                "height": 10,
                "units": "in",
                "columns": 2,
...
def build_gallery(project: "ResolvedProject", output: str | Path | None = None) -> Path:
    ...
    page = f"""<!doctype html>
<html><head><meta charset="utf-8"><title>BulkRNAFrame figure gallery</title>
...
<body><header><h1>BulkRNAFrame publication figure gallery</h1><p>{html.escape(project.project_id)} · generated from registered constructors. Statistical results are unchanged; this page reviews presentation variants.</p><p><a href="contact_sheet.png">Open contact sheet</a></p></header><main class="grid">{''.join(cards)}</main></body></html>"""
